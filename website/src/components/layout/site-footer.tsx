  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div><h2>Comunidade</h2><a href={siteConfig.repository} className="footer-github"><Code2 aria-hidden="true" /> GitHub</a><a href={siteConfig.issues}>Issues</a><a href={`${siteConfig.repository}/blob/main/CONTRIBUTING.md`}>Contribuir</a><a href={`${siteConfig.repository}/blob/main/SECURITY.md`}>Segurança</a></div>
      </div>
